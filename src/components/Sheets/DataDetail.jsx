                                        ...
                                        <>
                                            <tr
                                                ...
                                                <td className="py-2 px-2 border-b border-r text-center">
                                                    {aatSchedule.scheduleArray.length > 0 && <p className="font-semibold text-center text-[#beef70]">AAT</p>}
                                                    {aatSchedule.scheduleArray.map((item, i) => (
                                                        <div key={i} className="mb-1">
                                                            <p className="p-1 border border-white rounded-md">{item}</p>
                                                        </div>
                                                    ))}
                                                    {ftmSchedule.scheduleArray.length > 0 && <p className="font-semibold text-center text-[#beef70]">FTM</p>}
                                                    {ftmSchedule.scheduleArray.map((item, i) => (
                                                        <div key={i} className="mb-1">
                                                            <p className="p-1 border border-white rounded-md">{item}</p>
                                                        </div>
                                                    ))}
                                                    {fsstSchedule.scheduleArray.length > 0 && <p className="font-semibold text-center text-[#beef70]">FSST</p>}
