...
const FirstSheet = () => {
    ...
    const chartHeight = 240; // Adjust this value based on your chart's height
    ...
    const yAxisLabels = Array.from({ length: 5 }, (_, index) => interval * index).reverse(); // Reduce the number of labels
