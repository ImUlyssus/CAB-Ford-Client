    ...
    return (
        <div className="w-full h-full bg-white p-8">
            ...
            <h1 className="text-2xl font-bold mb-6 text-[#003478] border-b-2 border-gray-300 pb-2">
                Approved Change Requests Status <span className="text-blue-700">(Completed)</span>
            </h1>
                ...
                <table className="min-w-full border border-gray-300">
                    ...
                    <tbody className="text-black text-xs">
                        {changeRequests?.approved
                            ?.filter(request => request.final_status === "Completed with no issue") // Filtering step
                            .map((request, index) => (
                                <tr key={index}>
                                    <td className="bg-blue-700 text-white border border-gray-300 text-center">C</td>
