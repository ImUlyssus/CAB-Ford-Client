            ...
            <div className="w-full max-h-[80%] overflow-y-auto border border-gray-300">
                <table className="min-w-full border border-gray-300">
                    ...
                    <tbody className="text-black text-xs">
                        {changeRequests.toApprove.filter(request => request.change_sites.includes('fsst') && !request.change_sites.includes('aat') && !request.change_sites.includes('ftm')).map((request, index) => (
                            <tr key={index}>
